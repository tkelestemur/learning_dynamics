...
def plot_mse():
    ...
    mse_16h_1step = np.load('./results/checkpoint_16h_3step_no_init_mse.npy')
    ...
    ax.plot(mse_16h_1step_mean, c='r', label='16 hidden - 3 step w/o initialization', linewidth=2)
    ...
    ax.plot(mse_16h_3step_mean, c='g', label='16 hidden - 3 step w initialization', linewidth=2)
